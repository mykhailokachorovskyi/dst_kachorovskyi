...
def select_command(usr_command):
    ...
    def f_help():
        print("  >ping  - test the ability of the source computer;")
        print("  >echo  - display line of text;")
        print("  >login - establish a new session with the system (template);")
        print("  >list  - list all files and subdirectories contained in directory;")
        print("  >msg   - send a message to a specific user (template);")
        print("  >file  - send a file to a specific user (template);")
        print("  >exit  - close .")
